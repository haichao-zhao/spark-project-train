...
object ImoocLogV2App {

  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder()
      .appName("ImoocLogV2App")
      .master("local")
...
//    val input = s"hdfs://localhost:8020/access/$day/*"
        val input = "file:///Users/zhaohaichao/workspace/javaspace/spark-project-train/data/access1.log-20190131"
    ...
    hbaseinfoRDD.saveAsNewAPIHadoopFile(
      "hdfs://localhost:8020/etl/access2/hbase",
  ...
  def flushTable(tableName: String, conf: Configuration): Unit = {
